...
Output: <run-dir>/results/real_dual_branch_gated.json
...
def setup_logging(run_dir: Path) -> logging.Logger:
    ...
    fh = logging.FileHandler(run_dir / "stage_07_dual_gated.log")
...
def main() -> None:
    ...
    out_path = run_dir / "results" / "real_dual_branch_gated.json"
    if out_path.exists():
